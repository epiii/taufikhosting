...
<html class="sidebar_hover  no-js" lang="en">
    ...
    <div id="responsive_part">
      ...
      <ul class="nav responsive">
        <li>
          <button class="btn responsive_menu icon_item" data-toggle="collapse" data-target=".overview"> 
      ...
      <div class="viewport ">
	    ...
	    <!--<div class="overview collapse">
          ...
          <ul id="sidebar_menu" class="navbar nav nav-list container full">
            <li class="accordion-group  color_6"> 
            	<a class="dashboard " href="#home">
                	<img src="img/menu_icons/forms.png"><span>Home</span></a></li> 
            <li class="accordion-group  color_6"> 
            	<a class="dashboard " href="#admin">
                	<img src="img/menu_icons/forms.png"><span>Administrator</span></a></li> 
            <li class="accordion-group  color_4"> 
            	<a class="dashboard " href="#karyawan" >
                	<img src="img/menu_icons/dashboard.png"><span>Karyawan</span></a></li>
            <li class="accordion-group  color_3"> 
            	<a class="dashboard " href="#cidera" >
                	<img src="img/menu_icons/dashboard.png"><span>Cedera</span></a> </li>
           <li class="accordion-group  color_3"> 
            	<a class="dashboard " href="#tubuh" >
                	<img src="img/menu_icons/dashboard.png"><span>tubuh</span></a> </li>
           <li class="accordion-group  color_3"> 
            	<a class="dashboard " href="#tubuh" >
                	<img src="img/menu_icons/dashboard.png"><span>tubuh</span></a> </li>
            <li class="accordion-group color_7"> 
				...
				<img src="img/menu_icons/forms.png"><span>Form Elements</span></a>
              <ul id="collapse1" class="accordion-body collapse">
                <li><a class="dashboard"href="forms_general.html">General</a></li>
		   ...
		   <!--<li class="accordion-group color_3"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse2"> <img src="img/menu_icons/widgets.png"><span>UI Widgets</span></a>
            ...
            <li class="color_13"> <a class="dashboard" href="calendar2.html"> <img src="img/menu_icons/calendar.png"><span>Calendar</span></a> </li>
  ...
  <div class="container">
    ...
    <div id="loadingx"><img src="img/ajax-loader.gif"></div>
       <!--konten-->
        <div id='pageContent'>
			konten
