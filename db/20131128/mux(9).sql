...
--
-- Host: localhost
-- Generation Time: Nov 28, 2013 at 07:10 AM
...
INSERT INTO `tb_backbone` (`id_backbone`, `kode`, `keterangan`) VALUES
(1, 'SB - JR', ''),
(2, 'SB - RKT', ''),
(3, 'SB - ML', 'surabaya - malang'),
(4, 'SB - MN', ''),
(6, 'SB - JKT', ' surabaya - ?'),
(8, 'SB - BD', 'surabaya - bandung'),
(10, 'SB - SLO', 'surabaya - solo'),
(14, 'ZTE SB - D', 'surabaya - denpasar'),
(15, 'NE SB - D', 'sby dnpasar');

-- --------------------------------------------------------

--
-- Table structure for table `tb_dapot_kanal`
--

CREATE TABLE IF NOT EXISTS `tb_dapot_kanal` (
  `Id_dapot` int(11) NOT NULL AUTO_INCREMENT,
  `id_backbone` int(11) NOT NULL,
  `Netre` text NOT NULL,
  `Arnet` text NOT NULL,
  `LinkA` varchar(20) NOT NULL,
  `LinkB` varchar(20) NOT NULL,
  `id_sistra` int(11) NOT NULL,
  `Ket` varchar(200) NOT NULL,
  `Id_per` char(4) NOT NULL,
  `2mbps` int(11) NOT NULL,
  `stm1` int(11) NOT NULL,
  `stm4` int(11) NOT NULL,
  `stm16` int(11) NOT NULL,
  `stm64` int(11) NOT NULL,
  `sljj` int(11) NOT NULL,
  `mea` int(11) NOT NULL,
  `flexi` int(11) NOT NULL,
  ...
  PRIMARY KEY (`Id_dapot`),
  KEY `Id_per` (`Id_per`),
  KEY `id_backbone` (`id_backbone`),
  KEY `Sis_sarana` (`id_sistra`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `tb_dapot_kanal`
--
...
(1, 'topek', 'JALAN BEJO BANGET', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'sr6bu41kd5gakve0bfia5f7552'),
...
INSERT INTO `tb_perangkat` (`id`, `nama_per`, `merk`, `type`, `thn_oper`, `thn_noper`, `kanal`) VALUES
('P001', 'ZTE tt', 'ZTE', 'M920', 2000, 2003, 0),
('P002', 'ZTE ', 'ZTE', 'M920', 2000, 2008, 0),
('P004', 'ZTE ', 'ZTE', 'M9200', 2000, 2000, 0),
('P005', 'ZTE ', 'ZTE', 'M920', 2000, 2000, 0);
...
CREATE TABLE IF NOT EXISTS `tb_sirkit` (
  ...
  `id_per_detail` varchar(11) NOT NULL,
...
--
-- Constraints for table `tb_dapot_kanal`
--
ALTER TABLE `tb_dapot_kanal`
  ADD CONSTRAINT `tb_dapot_kanal_ibfk_1` FOREIGN KEY (`Id_per`) REFERENCES `tb_perangkat` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_dapot_kanal_ibfk_2` FOREIGN KEY (`id_backbone`) REFERENCES `tb_backbone` (`id_backbone`),
  ADD CONSTRAINT `tb_dapot_kanal_ibfk_3` FOREIGN KEY (`id_sistra`) REFERENCES `tb_sistra` (`id_sistra`);
