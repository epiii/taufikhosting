...
class Pagination_class{
    ...
    function Pagination_class($qry,$starting,$recpage)
    {
		...
		{
            $anc .= "<li pg=0 class='nextpaging'><a href='javascript:pagination(0);'>First </a></li>";
            $anc .= "<li pg=$previous class='nextpaging'><a href='javascript:pagination($previous);'>Previous </a></li>";
        }
        ...
        for($i=$page_showing; $i>1; $i--)
		{
            ...
            $anch = "<li class='prevnext' pg=$page><a href='javascript:pagination($page);'>$fpreviousPage </a></li>".$anch;
            if($j == $norepeat) break;
            $j++;
        }
        $anc .= $anch;
        ...
        for($i=$page_showing; $i<$total_page; $i++)
		{
            ...
            $anc .= "<li class='prevnext' pg=$page><a href='javascript:pagination($page);'>$fnextPage</a></li>";
            if($j==$norepeat) 
				break;
            $j++;
        }
		...
		{
            $anc .= "<li class='nextpaging' pg=$next><a href='javascript:pagination($next);'>Next </a></li>";
            $anc .= "<li class='nextpaging' pg=$last><a href='javascript:pagination($last);'>Last</a></li>";
        }
            $anc .= "</ul>";
        $this->anchors = $anc;
